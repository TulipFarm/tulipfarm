...
| `src/integrations/` | Integration install/state, scoped Connections, revision-fenced credential replacement and verification invalidation, OIM sync/ingress/trust state, and channel stores. |
