...
/** Payload-safe denial. Submitted field values and resume tokens never enter the message. */
...
/**
 * One submission funnel for standalone and in-Run forms. It validates under the current server
 * definition, then delegates canonical event creation or atomic RunWait redemption to durable ports.
 */
