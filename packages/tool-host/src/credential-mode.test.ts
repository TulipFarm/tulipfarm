...
import { type ConnectedCredential, InMemoryPrincipalCredentialReader } from "./test-doubles";
...
function connected(principal: { kind: string; id: string }, provider: string): ConnectedCredential {
  return {
