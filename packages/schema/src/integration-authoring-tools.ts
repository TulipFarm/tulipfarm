...
export const INTEGRATION_DRAFT_REVIEW_TOOL_DECLARATION = {
  ...
  description:
    "Validate and test a complete drafted OIM package, including setup-guide.md, digest-covered OpenAPI or GraphQL contracts, and passing offline fixture coverage for every operation. Reports exactly what it would be allowed to do and writes nothing. The returned package digest is what integration_draft_create spends.",
  mutating: false,
  inputSchema: {
    type: "object",
...
export const INTEGRATION_DRAFT_CREATE_TOOL_DECLARATION = {
  ...
  description:
    "Install the exact reviewed OIM package in the soul repo under integrations/<slug>. This approval-gated second phase takes the package digest integration_draft_review returned.",
  mutating: true,
  inputSchema: {
    type: "object",
    additionalProperties: false,
    ...
    properties: {
      ...
      replace: {
        type: "boolean",
        description: "Replace an installed integration of the same slug.",
      },
    },
  },
} as const;
...
export const INTEGRATION_GET_TOOL_DECLARATION = {
  ...
  description:
    "Read one installed integration package and, for an OIM package, the capability review derived from it.",
  mutating: false,
  inputSchema: {
    type: "object",
    additionalProperties: false,
...
export const INTEGRATION_LIST_TOOL_DECLARATION = {
  ...
  description: "List the integration packages installed in the soul repo.",
  mutating: false,
