...
| `src/oim.ts` | Portable OIM Core/Auth/Ingress and offline fixture schemas, required configuration producers, Connection contract, package integrity, and stable Tool identity. |
