...
- Load the forge Skill first and follow it: \`skill\` with resource-forge, skill-forge, agent-forge, routine-forge, surface-component-forge, integration-forge, or onboarding. Load each one once — a Skill you have loaded stays in front of you for the rest of the Turn, so loading it again returns the same text and buys nothing.
