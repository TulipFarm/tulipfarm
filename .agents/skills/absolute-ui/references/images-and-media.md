...
1. Full-screen dark overlay - simple but dulls the entire image
2. Linear gradient to solid - shows image at top, readable text at bottom
3. Progressive blur + gradient - shows image clearly, smoothly blurs into readable area (most modern)
