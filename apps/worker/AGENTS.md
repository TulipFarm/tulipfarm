...
- Validate shared persisted runtime identity and hosting authority before loops/probes; use its
  business scope to claim Runs. Identity conflicts and unsupported hosted trust fail startup.
