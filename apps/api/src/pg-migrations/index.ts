...
} from "./historical-integration-statements";
...
export const PG_MIGRATIONS: PgMigration[] = [
  ...
  {
    version: 117,
    description: "durable OIM ingress registration and teardown",
    up: applyStatements(
      INGRESS_TEARDOWN_STORAGE_STATEMENTS,
      WEBHOOK_REGISTRATION_STORAGE_STATEMENTS,
      OIM_INGRESS_EMISSION_STORAGE_STATEMENTS
  ...
  {
    version: 137,
    description: "MCP accounts, scoped grants and exact Chat account consent",
    up: applyStatements(MCP_ACCOUNT_STORAGE_STATEMENTS),
  },
  {
    version: 138,
    description: "MCP OAuth, execution authority, Knowledge sync and native channel inbox",
    up: applyStatements([
      ...MCP_OAUTH_STORAGE_STATEMENTS,
      ...MCP_EXECUTION_AUTHORIZATION_STORAGE_STATEMENTS,
      ...MCP_KNOWLEDGE_STORAGE_STATEMENTS,
