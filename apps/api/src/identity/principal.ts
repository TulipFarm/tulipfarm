...
/** Principal contract carries actor, proof type, and proof strength for step-up and audit. */
...
/** Only active local users authenticate; future lifecycle states must not default into access. */
...
/** Reject disabled users at every credential path, not just login. */
