...
| --- | --- | --- |
| SOC 2 security, availability, confidentiality | Default-deny authorization, durable effects, audit chains, recovery contracts | Assign owners, review access, configure retention, test recovery, and collect evidence |
| ISO 27001 access, operations, cryptography, incident management | Scoped grants, Secret leases, redaction, incident grouping, backup verification | Maintain an ISMS, risk treatment, key custody, incident exercises, and supplier review |
