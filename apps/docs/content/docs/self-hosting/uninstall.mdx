...
[one-line installer](/self-hosting/install), including all local data. It is intentionally
...
[second instance on one machine](/self-hosting/install#running-a-second-instance-on-one-machine)
