...
Tasks from the onboarding Companion — see [Get started](/docs/getting-started).
...
The name is recorded in that install's marker file, so [uninstalling](/docs/uninstall)
