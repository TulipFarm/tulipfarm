  ...
  return (
    <div className="lg:sticky lg:top-20">
      ...
      <p className="mt-1 text-xs text-fd-muted-foreground">
        {remaining === 0 ? "Every step marked done" : `${remaining} steps left`}
      </p>
      <div
      ...
      >
        <div
          className="h-0.5 bg-fd-foreground"
        ...
        {steps.map((step, index) => (
          <li key={step.id}>
            <a
              ...
              className="flex items-baseline gap-2 border-l-2 border-transparent py-1 pl-2 text-xs leading-6 text-fd-muted-foreground transition-colors hover:border-fd-primary hover:text-fd-foreground focus-visible:-outline-offset-2 data-[done]:line-through"
            >
...
function StepRow({
  ...
  return (
    <li
      ...
      className="group relative grid scroll-mt-5 grid-cols-[2.75rem_1fr] gap-x-2 py-1 sm:gap-x-3"
    >
      <label className="relative grid size-11 cursor-pointer place-items-center">
        ...
        <span
          aria-hidden
          className="grid size-6 place-items-center rounded-md border border-fd-border bg-fd-background text-fd-primary transition-colors peer-checked:border-fd-primary peer-hover:border-fd-primary peer-focus-visible:outline peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-fd-ring"
        >
      ...
      <div className="min-w-0">
        <div className="grid min-h-11 grid-cols-[auto_minmax(0,1fr)] items-baseline gap-x-3 sm:grid-cols-[auto_minmax(0,1fr)_auto]">
          ...
          <a
            ...
            className="col-start-2 inline-flex min-h-11 items-center gap-1 justify-self-start text-xs text-fd-muted-foreground transition-colors hover:text-fd-primary sm:col-auto sm:pl-3"
          >
            Full step <ArrowRight size={13} />
          </a>
        </div>
