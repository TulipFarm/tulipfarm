...
| The non-secret, reviewed configuration of an MCP Integration | **Integration definition** | `McpIntegrationDefinition` | `/api/v1/integrations/:slug` | "Server" | `integrations/<slug>/mcp.yaml`; transport, authentication requirements, enablement and reviewed capabilities. Credentials and account grants stay outside the Soul |
